...
static ST_DEVZJ_FUNREG_SYSTEM_TABLE  g_funReg_system_t = {0};
...
//	g_funReg_iothub_t.f_IoTHubWriteData = ZJ_IoTHubWriteData;
	...
	g_funReg_network_t.f_SetAutoConnStatus = ZJ_SetAutoConnStatus;
	//system
	g_funReg_system_t.f_CtrlDeviceId = ZJ_CtrlDeviceId;
	return 0;
}
